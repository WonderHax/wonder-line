...
export class SquareService {
    constructor(client) {
        this.protocolType = 4;
        this.requestPath = "/SQ1";
        this.errorName = "SquareServiceError";
        this.defaultSquareCoverImageObsHash = "0h6tJfahRYaVt3H0eLAsAWDFheczgHd3wTCTx2eApNKSoefHNVGRdwfgxbdgUMLi8MSngnPFMeNmpbLi8MSngnPFMeNmpbLi8MSngnPQ";
        this.client = client;
    }
    ...
    async deleteOtherFromSquare(squareMemberMid) {
