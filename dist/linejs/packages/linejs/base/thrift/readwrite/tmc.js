export class TMoreCompactProtocol {
    constructor(inputData, baseException, readWith) {
        this.huffmanTree = []; // Huffman tree lookup array
        this.huffmanPatterns = []; // Huffman code patterns
        this.typeSequence = []; // Decoded type sequence from header
        this.stringTable = []; // String lookup table
        this.reserved = []; // Reserved for future use
        this.lastFieldId = 0; // Last read field ID
        this.currentPosition = 0; // Current position in buffer
        this.lastStringId = 0n; // Last string ID for delta encoding
        this.res = null; // Parsed result
