...
var _ThriftRenameParser_instances, _ThriftRenameParser_name2fid, _ThriftRenameParser_fid2name;
...
export class ThriftRenameParser {
    constructor() {
        _ThriftRenameParser_instances.add(this);
        this.def = {};
    }
    rename_thrift(structName, object) {
        ...
        for (const fid in object) {
            ...
            const finfo = __classPrivateFieldGet(this, _ThriftRenameParser_instances, "m", _ThriftRenameParser_fid2name).call(this, structName, fid);
...
_ThriftRenameParser_instances = new WeakSet(), _ThriftRenameParser_name2fid = function _ThriftRenameParser_name2fid(structName, name) {
...
}, _ThriftRenameParser_fid2name = function _ThriftRenameParser_fid2name(structName, fid) {
    const struct = this.def[structName];
    if (struct && Array.isArray(struct)) {
        const result = struct.findIndex((e) => {
            return e.fid == fid;
