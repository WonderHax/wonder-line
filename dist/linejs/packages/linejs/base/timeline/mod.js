export class Timeline {
    ...
    async createPost(options) {
        ...
        return await this.client.fetch(`https://${this.client.request.endpoint}/${homeId[0] == "s" ? "sn" : "mh"}/api/v57/post/create.json?${params}`, { headers, body: JSON.stringify(data), method: "POST" }).then((r) => r.json());
    }
    async deletePost(options) {
        ...
        return await this.client.fetch(`https://${this.client.request.endpoint}/${homeId[0] == "s" ? "sn" : "mh"}/api/v57/post/delete.json?${params}`, { headers, method: "POST" }).then((r) => r.json());
    }
    async getPost(options) {
        ...
        return await this.client.fetch(`https://${this.client.request.endpoint}/${homeId[0] == "s" ? "sn" : "mh"}/api/v57/post/get.json?${params}`, { headers }).then((r) => r.json());
    }
    async listPost(options) {
        ...
        return await this.client.fetch(`https://${this.client.request.endpoint}/${homeId[0] == "s" ? "sn" : "mh"}/api/v57/post/list.json?${params}`, { headers }).then((r) => r.json());
    }
    async updatePost(options) {
        ...
        return await this.client.fetch(`https://${this.client.request.endpoint}/${homeId[0] == "s" ? "sn" : "mh"}/api/v57/post/update.json?${params}`, { headers, body: JSON.stringify(data), method: "POST" }).then((r) => r.json());
    }
