...
if (flags.thrift !== undefined && flags.input !== undefined) {
    ...
    const thrift = parseThrift(Deno.readTextFileSync(flags.input || fromFileUrl(import.meta.resolve("../../resources/line/line.thrift"))));
    Thrift = thrift;
    Deno.writeTextFileSync(flags.thrift || fromFileUrl(import.meta.resolve("../../packages/types/thrift.ts")), "export const Thrift: Record<string, Record<string, string> | any[]> = " +
...
if (flags.type !== undefined) {
    ...
    typedef(Thrift, flags.type || undefined);
}
if (flags.struct !== undefined) {
    console.log("generating struct parser...");
    struct(Thrift, flags.struct || undefined);
}
